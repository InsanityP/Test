...
import projectblokd.Items.Bazooka;
import projectblokd.Items.Cheater;
import projectblokd.Items.Helper;
import projectblokd.Items.HelperPad;
import projectblokd.Items.Muur;
import projectblokd.Items.Pad;
import projectblokd.Items.Speler;
import projectblokd.Items.Teleporter;
import projectblokd.Items.Vriend;
...
//    } 
    ...
    public void findPath(int x, int y) {
        ...
        int richtingen = availableDirections();
        ...
        switch (richting) {
            case "noord":
                lr.setSpeler(pX, pY + 1);
                break;
            case "oost":
                lr.setSpeler(pX - 1, pY);
                break;
            case "west":
                lr.setSpeler(pX + 1, pY);
                break;
